...
if(isset($_REQUEST["deviceid"])){
    $query=$pdo->prepare("SELECT id,type,user_group,firstname,lastname,designation,location,user_image_stat,user_image,user_used,user_event FROM user WHERE device_id=:deviceid");
    $query->execute(array(
